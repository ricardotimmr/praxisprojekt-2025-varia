...
/**
 * The main landing page component for the Varia application.
 * This component displays the hero section, features, how-it-works, and a footer.
 */
const Index = () => {
  const location = useLocation();

  /**
   * Scrolls the window to the features section of the page.
   */
